        ...
        >
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            {selected.provider.auth === "oauth2" ? <>
              ...
              <div className="md:col-span-2 rounded-xl border border-primary/25 bg-primary/5 p-3 text-xs text-muted-foreground">Use repository Metadata read access, plus read access for pull requests, issues, and checks. Check verifies the token with GitHub, and Rasputin only calls GitHub GET endpoints.</div>
            </> : <>
